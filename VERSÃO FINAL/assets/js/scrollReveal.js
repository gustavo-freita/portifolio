...
ScrollReveal().reveal('.container__inicio .inicio__titulos span, .container__sobre span, .container__habilidades .titulo__habilidades span, .container__projetos span', { delay: 300, origin:'right' });
...
ScrollReveal().reveal('.sobre__resumoSobreMim', { delay: 600, origin:'bottom' });
 *//* Animação Sobre */
